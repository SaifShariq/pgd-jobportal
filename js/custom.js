...
var JobBoard = function(){
	...
	/* Header Text Function Loop*/
	$(function() { 
		function headerLoop(){
		$("#header2,#header3,#header4,#header5").hide();
			$("#header1").delay(1500).fadeOut('slow', function(){	
				$("#header2").fadeIn('slow',function(){		
					$("#header2").delay(1500).fadeOut('slow',function(){		
						$("#header3").fadeIn('slow',function(){		
							$("#header3").delay(1500).fadeOut('slow',function(){		
								$("#header4").fadeIn('slow',function(){		
									$("#header4").delay(1500).fadeOut('slow',function(){		
										$("#header5").fadeIn('slow',function(){		
											$("#header5").delay(1500).fadeOut('slow',function(){		
												$("#header1").fadeIn('slow')		
											})	
										})
									})
